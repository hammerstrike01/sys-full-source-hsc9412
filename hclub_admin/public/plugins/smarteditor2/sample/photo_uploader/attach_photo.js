 	...
 	function callFileUploader (){
		alert(location.href.replace(/\/[^\/]*$/, ''));
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/public/plugins/smarteditor2/sample/photo_uploader/file_uploader_html5.php',	//샘플 URL입니다.
 	        sCallback : '/public/plugins/smarteditor2/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
